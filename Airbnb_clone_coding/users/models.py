...
class User(AbstractUser):
    ...
    gender = models.CharField(choices=GENDER_CHOICES,max_length=10, null=True,blank=True)  #charfield 한줄필드
    bio = models.TextField(default="",blank=True) #textfield 필드제한없음
